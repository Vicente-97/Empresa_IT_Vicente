...
public abstract class Candidate implements Comparable<Candidate>{
	...
	public int compareTo(Candidate otro) {
		int resultado=0;
		if (otro!=null) {
			if(this.startDate!=null && otro.startDate!=null &&
					this.startDate.isBefore(otro.startDate)) {
				resultado=-1;
			
			}else if (this.startDate!=null && otro.startDate!=null &&
					this.startDate.isAfter(otro.startDate)) {
				resultado=1;
			}
		}
	...
	public String toString() {
		return " Soy un "+ obtenerClase() + " con dni " + getDni() +  " y empece a trabajar en :" + getStartDate().getYear();
	}
