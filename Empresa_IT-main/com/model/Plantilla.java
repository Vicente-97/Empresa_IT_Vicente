...
public class Plantilla {
	...
	public Plantilla () {
		...
		Candidate c1= new WebDesigner(LocalDate.of(1990, 12, 01),
				LocalDateTime.of(1980, 12, 3, 0, 0,0), 
				"123456789Ñ",
				"Jose Manuel",
				"Sevillano",
		...
		Candidate c2= new WebDesigner(LocalDate.of(1992, 12, 05), 
				LocalDateTime.of(1981, 11, 3, 0, 0,0),
				"123456789L",
				"Jose Manuel",
				"Gómez",
				ContractType.FULLTIME);
		...
		Candidate c3= new WebDesigner(LocalDate.of(1993, 12, 05), 
				LocalDateTime.of(1979, 07, 3, 0, 0,0),
				"123456789V",
				"Jose",
				"Bombo",
				ContractType.FULLTIME);
		...
		Candidate b1 = new BackendProgrammer(LocalDate.of(1983, 12, 05), 
				LocalDateTime.of(1979, 06, 3, 0, 0,0),
				"123456789P",
				"Vicente",
				"Ruiz",
		...
		Candidate b2 = new BackendProgrammer(LocalDate.of(1985, 05, 05), 
				LocalDateTime.of(1978, 11, 3, 0, 0,0),
				"123456789Q",
				"Rosa",
				"Ruiz",
				ContractType.PARTIAL);
		...
		Candidate b3 = new BackendProgrammer(LocalDate.of(1986, 12, 05), 
				LocalDateTime.of(1981, 02, 3, 0, 0,0),
				"123456789Y",
				"Manuel",
				"Ruiz",
				ContractType.FULLTIME);
		...
		Candidate b4 = new BackendProgrammer(LocalDate.of(1986, 07, 05), 
				LocalDateTime.of(1980, 05, 3, 0, 0,0),
				"123456789S",
				"Sara",
				"La marquesa",
				ContractType.FULLTIME);
		...
		Candidate b5 = new BackendProgrammer(LocalDate.of(1981, 12, 05), 
				LocalDateTime.of(1980, 06, 3, 0, 0,0),
				"123456789B",
				"Javi",
				"Mohammed",
				ContractType.FULLTIME);
		...
		Candidate b6 = new BackendProgrammer(LocalDate.of(1999, 12, 05), 
				LocalDateTime.of(1992, 03, 3, 0, 0,0),
				"123456789W",
				"Ivan",
				"Y Vienen",
				ContractType.FULLTIME);
		...
		// 2 full stack
		Candidate fs1 = new FullStackDeveloper(LocalDate.of(1978, 12, 05), 
				LocalDateTime.of(1977, 04, 3, 0, 0,0),
				"123456789U",
				"Rosamel",
				"Eso",
				ContractType.FULLTIME);
		...
		Candidate fs2 = new FullStackDeveloper(LocalDate.of(1987, 12, 05), 
				LocalDateTime.of(1983, 07, 3, 0, 0,0),
				"123456789X",
				"Jaime",
				"Caravaca",
				ContractType.FULLTIME);
...
public String ordenarPlantilla() {
	...
	public Double obtenerSalario() {
		...
		}else if(opciones.equalsIgnoreCase("m")&& opciones3.equalsIgnoreCase("b")&& opciones4.equalsIgnoreCase("p")) {
		resultado= (costoMB-(costoMB*parcial));
		}else if(opciones.equalsIgnoreCase("m")&& opciones3.equalsIgnoreCase("f")&& opciones4.equalsIgnoreCase("f")) {
			resultado= costoMF;
		}else if(opciones.equalsIgnoreCase("m")&& opciones3.equalsIgnoreCase("f")&& opciones4.equalsIgnoreCase("f")) {
			resultado= costoMB;
		}else if(opciones.equalsIgnoreCase("d")&& opciones3.equalsIgnoreCase("b")&& opciones4.equalsIgnoreCase("p")) {
			resultado= (costoDB-(costoDB*parcial));
		}else if(opciones.equalsIgnoreCase("d")&& opciones3.equalsIgnoreCase("f")&& opciones4.equalsIgnoreCase("p")) {
			resultado= (costoDF-(costoDF*parcial));
		}else if(opciones.equalsIgnoreCase("d")&& opciones3.equalsIgnoreCase("b")&& opciones4.equalsIgnoreCase("f")) {
			resultado=costoDB;
		}else if(opciones.equalsIgnoreCase("d")&& opciones3.equalsIgnoreCase("f")&& opciones4.equalsIgnoreCase("f")) {
			resultado=costoDF;
		}
